        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="bg-medical-blue rounded-[2.5rem] p-8 md:p-12 text-white relative overflow-hidden shadow-2xl shadow-medical-blue/30">
                <div className="relative z-10">
                    <h3 className="text-3xl font-black mb-4 uppercase tracking-tight">{t("Dossier Réglementaire Centralisé", "Centralized Regulatory Vault")}</h3>
                    <p className="text-medical-blue-light font-medium max-w-2xl text-lg">
                        {t("MediUnit archive automatiquement tous les certificats CE et fiches techniques liés à vos acquisitions cliniques pour faciliter vos audits.", "MediUnit automatically archives all CE certificates and technical data sheets linked to your clinical acquisitions to facilitate your audits.")}
                    </p>
                </div>
            ...
            <div className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-slate-gray-light/10 shadow-xl shadow-medical-blue/5">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <h4 className="text-xl font-black text-slate-gray-dark flex items-center gap-3">
                        ...
                        {t("Index des Documents", "Document Index")} ({filteredDocs.length})
                    </h4>
                    ...
                    <div className="relative w-full md:w-80">
                        ...
                        <input
                            type="text"
                            placeholder={t("Chercher un certificat...", "Search for a certificate...")}
                            value={searchTerm}
                    ...
                    {filteredDocs.map((doc, i) => (
                        <div key={i} className="group p-6 bg-clinic-white rounded-[2rem] border border-slate-gray-light/5 hover:border-medical-blue hover:shadow-lg hover:shadow-medical-blue/5 transition-all">
                            ...
                            <p className="text-[10px] text-slate-gray font-medium flex items-center gap-1 mb-4">
                                ...
                                {t("Vérifié par MediUnit Clinical", "Verified by MediUnit Clinical")}
                            </p>
                ...
                {filteredDocs.length === 0 && (
                    <div className="text-center py-20 bg-clinic-white rounded-[2rem] border-2 border-dashed border-slate-gray-light/10">
                        ...
                        <h5 className="text-lg font-bold text-slate-gray-dark">{t("Aucun document trouvé", "No document found")}</h5>
                        <p className="text-slate-gray text-sm">{searchTerm ? t("Ajustez votre recherche.", "Adjust your search.") : t("Vos documents apparaîtront ici après vos premières commandes.", "Your documents will appear here after your first orders.")}</p>
                    </div>
                )}
            </div>
        </div>
