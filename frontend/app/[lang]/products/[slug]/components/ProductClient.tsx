            ...
            <main className="max-w-7xl mx-auto px-4 py-8 md:py-16">
                ...
                <div className="mt-24 grid grid-cols-1 lg:grid-cols-3 gap-16 border-t border-slate-gray-light/10 pt-16">
                    <div className="lg:col-span-2">
                        ...
                        <div className="text-slate-gray leading-relaxed text-lg font-medium mb-12 clinical-description prose prose-slate max-w-none whitespace-pre-wrap">
